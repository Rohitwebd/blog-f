            ...
            <div className="col-lg-12">
              <div className="testimonial-slider-wrap text-center">
                ...
                <div id="testimonial-nav">
                  <span className="prev" data-controls="prev"><FontAwesomeIcon icon={faChevronCircleLeft} /></span>
                  <span className="next" data-controls="next"><FontAwesomeIcon icon={faChevronCircleRight} /></span>
                </div>
